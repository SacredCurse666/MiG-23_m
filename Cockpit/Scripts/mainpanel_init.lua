...
Throttle_Anim						= CreateGauge("parameter")
Throttle_Anim.parameter_name		= "THROTTLE_POS"
Throttle_Anim.arg_number			= 2016
Throttle_Anim.input					= {0, 1}
Throttle_Anim.output				= {0, 1}
...
-- ELECTRICAL SYSTEM
---------------------------------------------------------------
DC_Voltage_Gauge                    = CreateGauge("parameter")
DC_Voltage_Gauge.parameter_name     = "ELEC_DC_VOLTAGE"
DC_Voltage_Gauge.arg_number         = 2005 
DC_Voltage_Gauge.input              = {0, 15, 30}
DC_Voltage_Gauge.output             = {0, 0.5, 1.0}
...
MainHydroPressGauge                     = CreateGauge("parameter")
MainHydroPressGauge.parameter_name      = "MAIN_HYDRO_PRESS"
MainHydroPressGauge.arg_number          = 125
MainHydroPressGauge.input               = {0.0, 250.0} -- Шкала до 250 кг/см2
MainHydroPressGauge.output              = {0.0, 1.0}

BoosterHydroPressGauge                  = CreateGauge("parameter")
BoosterHydroPressGauge.parameter_name   = "BOOSTER_HYDRO_PRESS"
BoosterHydroPressGauge.arg_number       = 124
...
BrakeRightGauge.arg_number              = 2001
...
BrakeLeftWheelGauge.arg_number           = 2002
...
BrakeRightWheelGauge.arg_number           = 2003
BrakeRightWheelGauge.input                = {0.0, 12.0}
BrakeRightWheelGauge.output               = {0.0, 1.0}

BrakeLeverAnim                           = CreateGauge("parameter")
BrakeLeverAnim.parameter_name            = "BRAKE_LEVER_ANIM"
BrakeLeverAnim.arg_number                = 2004
BrakeLeverAnim.input                     = {0.0, 1.0}
BrakeLeverAnim.output                    = {0.0, 1.0}

-----------------------------------------------------------------
-- UVP-15 (Cabin Altitude & Pressure Diff)
-----------------------------------------------------------------
UVP_Drum_Gauge                    = CreateGauge("parameter")
UVP_Drum_Gauge.parameter_name     = "UVP_DRUM"
UVP_Drum_Gauge.arg_number         = 2006
UVP_Drum_Gauge.input              = {0, 1}
UVP_Drum_Gauge.output             = {0, 1}

UVP_Needle_Gauge                  = CreateGauge("parameter")
