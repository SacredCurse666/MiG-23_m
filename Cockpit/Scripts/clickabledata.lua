...
elements["PNT_OXY_VALVE"] = default_2_position_tumb("Кислородный кран (ОТКР/ЗАКР)", devices.OXYGEN_SYSTEM, device_commands.OxygenToggle, 2018)
elements["PNT_OXY_VALVE"].connector = "OXY_VALVE_POS"
