...
elements["PNT_158"].relative = {false,false}--{true, true}
--elements["PNT_158"].arg_value = {{0, 1}, {0, 1}}
elements["PNT_158"].arg_lim = {{0, 1}, {0, 1}}
--elements["PNT_158"].stop_action = nil

-- ЭТО РАБОТАЕТ -- elements["PNT_158"] = default_button("Winding crown", devices.RADARWARN, device_commands.warn_crown_push, 158,1,1)

--commands.warn_crown_twist, 157, 0.0, 0.1, false, false, {0,1})
--elements["PNT_158"] = default_button_axis("Winding crown", devices.RADARWARN, device_commands.warn_crown_push, 158, 0.0, 0.1, false, true, {0,1})

-- elements["PNT_14"] = default_axis_limited("Starter", devices.RADARWARN, device_commands.starter_twist, 159, 0.0, 0.1, false, true, {0,1})
-- ЭТО РАБОТАЕТ -- elements["PNT_160"] = default_button("Starter", devices.RADARWARN, device_commands.starter_push, 160, 1, 1)
...
-- elements["PNT_997"] = default_2_position_tumb("Alternate Ejection Handle", devices.BAILOUT ,device_commands.CPT_secondary_ejection_handle, 997, nil)
elements["PNT_128"] = default_2_position_tumb("Ejection Handle", devices.CANOPY, device_commands.jettison_canopy, 998)
elements["PNT_128"].sound = {{JETTISON_HANDLE_PULL, JETTISON_HANDLE_PULL}}
