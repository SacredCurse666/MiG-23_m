...
Keys =
{
    ...
    IntLightRedFloodToggle          = __custom_counter(),
...
device_commands =
{
    ...
    warn_alt = 3020,                         --!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    BatteryExtSwitch = __counter(),
    GeneratorDCSwitch = __counter(),
    GeneratorACSwitch = __counter(),
    pneumo_brake_lever = __counter(),
    ...
    FuelPump_Tank1 = __counter(),
    FuelPump_Tank3 = __counter(),
    FuelPump_ExpI = __counter(),
    FuelPump_ExpII = __counter(),
    
    StartButton = __counter(),
    StartCover = __counter(),
    StartPTO = __counter(),
    StartMode = __counter(),
    ThrottleLock                   = __counter(),
