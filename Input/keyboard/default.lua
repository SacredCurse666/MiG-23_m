...
--[[
    ...
    {combos = {{key = 'F'}}, down = Keys.PlaneAirBrake, name = _('Airbrake'), category = _('Brake')},
    --{combos = {{key = 'B'}}, down = iCommandPlaneAirBrake, name = _('Airbrake22'), category = _('Systems')},
    ...
    {combos = {{key = 'F', reformers = {'LCtrl'}}}, down = Keys.PlaneFlapsDown, name = _('Flaps Down'), category = _('Systems')},
    {combos = {{key = 'F', reformers = {'LShift'}}}, down = Keys.PlaneFlaps, name = _('Flaps Up'), category = _('Systems')},
    ...
    {combos = {{key = 'Home', reformers = {'RAlt'}}}, down = Keys.Engine_Start, name = _('Engines Start Button'), category = _('Systems')},
    {combos = {{key = 'End', reformers = {'RAlt'}}}, down = Keys.Engine_Stop, name = _('Engines Stop Button'), category = _('Systems')},
...
--[[
  ...
  -- Custom
    ...
    {down = device_commands.BtnFlapsTakeOff,    up = device_commands.BtnFlapsTakeOff,   cockpit_device_id = devices.FLAP_SYSTEM,  value_down = 1.0,   value_up = 1, name = _('BtnFlapsTakeOff'), category = {_('System')}},

    {combos = {{key = ',', reformers = {'LShift'}}}, pressed = Keys.RadarAltWarningUp, up = Keys.TrimStop,  name = _('Rudder Trim Switch - Left'),               category = {_('Throttle Panel'), _('Flight Control')}},
    {combos = {{key = '.', reformers = {'LShift'}}}, pressed = Keys.RadarAltWarningDown , up = Keys.TrimStop, name = _('Rudder Trim Switch - Right'),              category = {_('Throttle Panel'), _('Flight Control')}},

    {combos = {{key = 'W', reformers = {'LShift'}}}, down = Keys.IncreasWingAngle, up = Keys.WingStop,  name = _('Rudder Trim Switch - Left'),               category = {_('Throttle Panel'), _('Flight Control')}},
    {combos = {{key = 'W', reformers = {'LCtrl'}}}, down = Keys.ReducWingAngle , up = Keys.WingStop, name = _('Rudder Trim Switch - Right'),              category = {_('Throttle Panel'), _('Flight Control')}},

    -- {combos = {{key = 'F', reformers = {'LShift'}}}, pressed = Keys.IncreasWingAngle, up = Keys.WingStop, name = _('Increasing the angle of rotation of the wing'), category = { _('Flight Control')}},
    -- {combos = {{key = 'F', reformers = {'LCtrl'}}}, pressed = Keys.ReducWingAngle, up = Keys.WingStop, name = _('Reducing the angle of rotation of the wing'), category = { _('Flight Control')}},
  --[[
    -- Cockpit Camera Motion
